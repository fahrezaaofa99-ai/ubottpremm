...
class Bot(Client):
    def __init__(self, **kwargs):
        super().__init__(**kwargs, device_model="JunOfficial✪")
    ...
    async def start(self):
        # opsional: jika butuh session untuk bot biasa, inisialisasi di sini
        await super().start()
...
class Ubot(Client):
    ...
    async def start(self):
        # Inisialisasi session di sini agar ada running event loop
        await get_aiosession()
        await super().start()
