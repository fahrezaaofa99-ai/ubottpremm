...
🚀ʙᴏᴛ ɪɴɪ ᴅɪᴋᴇᴍʙᴀɴɢᴋᴀɴ ᴏʟᴇʜ <a href=tg://openmessage?user_id={OWNER_ID}>@padukarezx</a> ᴊɪᴋᴀ ᴀᴅᴀ ᴋᴇsᴀʟᴀʜᴀɴ ᴀᴛᴀᴜᴘᴜɴ ᴍᴀsᴀʟᴀʜ ᴅᴍ ᴏᴡɴᴇʀ ʙᴏᴛ 𝙳𝙸 𝙰𝚃𝙰𝚂 

ᴘᴜʙʟɪᴄ ғɪᴛᴜʀ:
/freerezz

𝙲𝙰𝚁𝙰 𝚂𝙴𝚆𝙰 ʀᴇᴢᴢ 𝚄𝚂𝙴𝚁𝙱𝙾𝚃:
